            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Complaints Not Yet Attended</h1>
                        <?php
                            $pdo= new PDO("mysql:host=localhost;dbname=lecodb","root","");
                            $query = "select * from complaint";
                            $d=$pdo->query($query);
                        ?>
                        <form action="updateStatusN.php" method="POST">
                        <table class="com_table" style="text-align:center">
                            <tr>
                                <th>Complaint ID</th>
                                <th>User ID</th>
                            ...
                            <tr>
                                ...
                                <td>
                                <form action="updateStatusN.php" method="POST">
                                    <input type="hidden" name="id" value="<?php echo $data['CID']; ?>" id="id"/>
                                    <input type="submit" class="btn btn-secondary" value="Processing" name="update" id="update">
                                </form>
                                </td>
                                <td>
                                    <?php
